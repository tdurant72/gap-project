...
export default {
    data:  function(items) {
        return{
            items: [
            {name: 'Grow', img: require('../assets/img/icon-grow.png'), desc: 'How & why to grow your company at NC Global TransPark.', link:'#grow'},
            {name: 'Live', img: require('../assets/img/icon-live.png'), desc: 'Experience the quality of life we have to offer.', link:'#live'},
            {name: 'Work', img: require ('../assets/img/icon-work.png'), desc: 'A customizable workforce with state of the art training.', link:'#work'}
            ]
        }
  }
}
...
box-shadow: 0 2px 0 0 #1976D2, inset 0 2px 0 0 #BBDEFB; */
}
</style>
